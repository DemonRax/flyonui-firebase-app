...
export const Menu: FC = () => {
    ...
    return <nav className="navbar bg-base-100 rounded-box shadow">
        ...
        <div className="navbar-end flex items-center gap-4">
            ...
            <Theme />
            <div
                className={'dropdown relative inline-flex [--auto-close:inside] [--offset:8] [--placement:bottom-end]' + (!authenticated && ' hidden')}>
